...
//在flink当中，对于晚于watermark的延迟数据，flink有3种处理方式：方式2：通过配置allowedLateness参数（窗口延迟时间）来重新触发相应窗口的计算。
public class Watermark_LateEvent_AllowedLateness {
    public static void main(String[] args) throws Exception {
        ...
        env.execute("Watermark_LateEvent_AllowedLateness");
    }
}
