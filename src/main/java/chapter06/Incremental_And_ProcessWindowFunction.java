...
public class Incremental_And_ProcessWindowFunction {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> processDS = dataWS.reduce(new ReduceFunction<Tuple2<String, Integer>>() {
            @Override
            ...
            public void process(String key, Context context, Iterable<Tuple2<String, Integer>> elements, Collector<String> out) throws Exception {
                ...
                out.collect("Key:" + key + " 窗口开始时间:" + windowStart + " 窗口结束时间:" + windowEnd + "  单词统计次数: " + String.valueOf(result.f1));
            }
        });
