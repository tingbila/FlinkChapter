...
//在Flink程序中使用DropwizardMeterWrapper类注册DropWizardmeter
public class SocketWordCountMeter2 {
    public static void main(String[] args) throws Exception {
        ...
        DataStream<WaterSensor> streamOperator = mapDataStream.map(new RichMapFunction<WaterSensor, WaterSensor>() {
            ...
            public void open(Configuration parameters) throws Exception {
                ...
                meter = myGroup.meter("myMeter", new DropwizardMeterWrapper(dropwizardMeter));   //Flink中代码提供了内置实现MeterView
            }
            @Override
        ...
        env.execute("SocketWordCountMeter2");
    }
}
